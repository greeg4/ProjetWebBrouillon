...
require '../lib/classes/connexion.class.php';
require '../lib/classes/chenil.class.php';
require '../lib/classes/chenilManager.class.php';
...
$pdf->SetXY(3, 2); // bord supérieur gauche
